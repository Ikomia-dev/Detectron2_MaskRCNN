...
# --------------------
class Detectron2_MaskRCNNParam(core.CProtocolTaskParam):
...
# --------------------
class Detectron2_MaskRCNNProcess(dataprocess.CImageProcess2d):

    def __init__(self, name, param):
        dataprocess.CImageProcess2d.__init__(self, name)
        if param is None:
            self.setParam(Detectron2_MaskRCNNParam())
        else:
            self.setParam(copy.deepcopy(param))

        # get and set config model
        self.LINK_MODEL = "COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml"
        self.threshold = 0.5
        self.cfg = get_cfg()
...
# --------------------
class Detectron2_MaskRCNNProcessFactory(dataprocess.CProcessFactory):

    def __init__(self):
        dataprocess.CProcessFactory.__init__(self)
        # Set process information as string here
        self.info.name = "Detectron2_MaskRCNN"
        self.info.shortDescription = "Mask R-CNN inference model of Detectron2 for object detection and segmentation."
    ...
    def create(self, param=None):
        ...
        return Detectron2_MaskRCNNProcess(self.info.name, param)
